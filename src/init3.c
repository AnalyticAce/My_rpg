...
void initialize_sprites1(Game *game)
{
    for (int i = 0; i < NUM_SPRITES; i++) { char filename[256] = "img/sprite";
    ...
    game->background_texture = sfTexture_createFromFile("img/map.png", NULL);
